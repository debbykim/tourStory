...
<%@include file="navi.jsp"%>
    ...
    <div class="page-content">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="tourKor.go">여행스토리</a></li>
        <li>
      ...
      <section class="catalog-grid">
		...
		<table>
			...
			<th class="notice_name" >게시자</th>
				...
				<select id="category">
				<option value="non" id="non" selected="selected">게시판 선택</option>
			...
			<tr>
				...
				<td class="notice_list_center" id="board_subject">
				${subject}</td>
			</tr>
			...
			<tr>
				...
				<input type="hidden" name="board_subject" value="${subject}">
