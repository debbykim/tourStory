		...
		<div class="row">
			<section class="contain-notice extra-space-bottom">
				...
				<div class="inner" id="qna_list_all">
					...
					<td class="notice_list_left">${subject}</td>
					</tr>
					<tr>
			...
			<tr>
				...
				<input type="hidden" name="board_subject" value="${subject}" id="sub">
				<input type="hidden" name="board_content" value="" id="con">
				<input type="hidden" name="board_category" value="${cate}" id="category"/>
				<input type="hidden" name="board_num" value="${dto.board_num}" id="num"/>
